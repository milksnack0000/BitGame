...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.enemy_move_right = [pygame.image.load("Sprite/Enemy_move/right_1.png").convert_alpha(), pygame.image.load("Sprite/Enemy_move/right_2.png").convert_alpha()]
        self.enemy_move_left = [pygame.image.load("Sprite/Enemy_move/left_1.png").convert_alpha(), pygame.image.load("Sprite/Enemy_move/left_2.png").convert_alpha()]
        self.Walkcount = 0
