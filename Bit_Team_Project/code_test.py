...
class Player(pygame.sprite.Sprite):
    ...
    def draw_exp(self):
        ...
        exp_bar = pygame.Rect(screen_width/2 -20 , 0, exp_bar_width,6)
		
        pygame.draw.rect(screen,(50,238,254),exp_bar)	
        pygame.draw.rect(screen,(0, 0, 0),(screen_width/2 -20 , 0, self.health_bar_length,6),1)
